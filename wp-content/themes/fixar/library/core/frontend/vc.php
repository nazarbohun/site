...
function fixar_vc_map($params, $cssAnimation = array(), $icons = false, $order=0) {
...
add_action( 'vc_before_init', 'fixar_integrateWithVC', 200 );

function fixar_integrateWithVC() {


    //////////////////////////////////////////////////////////////////////

	if(isset($_GET['vc_action']) && $_GET['vc_action'] == 'vc_inline'){
		wp_enqueue_style('fixar-theme', get_stylesheet_directory_uri() . '/css/editor_styles.css');
	}
