...
jQuery(function($){
    ...
    wp.customize( 'fixar_header_level1_proportions', function( value ) {
    ...
    wp.customize( 'fixar_general_settings_logo_horizontal_pos', function( value ) {
        value.bind( function( to ) {
            if ( to ) {
    ...
    wp.customize( 'fixar_general_settings_logo_vertical_pos', function( value ) {
        value.bind( function( to ) {
            if ( to ) {
