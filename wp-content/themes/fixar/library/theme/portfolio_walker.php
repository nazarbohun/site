...
class fixar_Portfolio_Walker extends Walker_Category {
...
class fixar_Portfolio_Walker2 extends Walker_Category {
    function start_el(&$output, $category,  $depth=0, $args=array(),  $id=0) {
		extract($args);
...
class fixar_Isotope_Category_Walker extends Walker_Category {
