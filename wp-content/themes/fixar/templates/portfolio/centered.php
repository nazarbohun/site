		...
		<div class="image">
			...
			if ( $fixar_portfolio_post_type == 'image' ) : ?>
					<div class="single-portfolio-carousel owl-carousel enable-owl-carousel owl-theme" data-auto-play="4000" data-single-item="true"  data-items="1" data-responsive-items="1" data-pagination="true">
						<div class="item">
							<a href="<?php echo esc_url($fixar_portfolio_link); ?>" class="fancybox" rel="gallery[pp_gal_001]">
			...
			if ( $fixar_portfolio_post_type == 'video' ) : ?>
				...
				if ( $fixar_portfolio_video_href != '' ) :
					...
					?>
					<div class="controls">
						<div class="big-view"><a href="<?php echo esc_url($fixar_portfolio_video_href.'?width='.esc_attr($fixar_portfolio_video_width).'&amp;height='. esc_attr($fixar_portfolio_video_height)) ?>" class="fancybox" data-rel="gallery[pp_video_<?php echo esc_attr($post->ID); ?>]"  ><span class="theme-fonts-Media"></span></a></div>
					</div>
				<?php
				endif;
				?>
