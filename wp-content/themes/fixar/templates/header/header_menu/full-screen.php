		...
		<?php
			if(fixar_get_option('header_menu_add','')) {
				wp_nav_menu(array(
					...
					'link_before'     => '<span>',
					'link_after'      => '</span>',
					'walker' 		=> new fixar_Walker_FullScreen_Menu(),
				));
			} else {
				esc_attr_e('Additional menu has not been selected. Do this in the Customize &rarr; Header &rarr; Additional Menu.', 'fixar');
			}
		?>
