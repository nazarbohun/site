				...
				<div class="header-topbarbox-1">
					<ul>
						<?php if ($fixar_header['header_email']) : ?>
							<li><?php esc_attr_e('E-mail:', 'fixar') ?> <?php echo wp_kses_post(fixar_get_option('header_email', '')) ?></li>
						<?php endif; ?>
					</ul>
				</div>
		...
		<div class="header-navibox-2">
			<div class="container">
				...
				<?php if ($fixar_header['header_phone']) : ?>
					<ul class="phone-menu"><li class="no-hover"><?php esc_attr_e('call us', 'fixar') ?> <?php echo wp_kses_post(fixar_get_option('header_phone', '')) ?></li></ul>
				<?php endif; ?>
			</div>
