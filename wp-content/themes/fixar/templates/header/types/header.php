<?php /* Header Type 1 */
	...
	$fixar_logo_stl .= fixar_get_option('general_settings_logo_padding_top') != '' ? 'padding-top:'.esc_attr(fixar_get_option('general_settings_logo_padding_top')).'px;' : '';
	$fixar_logo_stl .= fixar_get_option('general_settings_logo_padding_right') != '' ? 'padding-right:'.esc_attr(fixar_get_option('general_settings_logo_padding_right')).'px;' : '';
	$fixar_logo_stl .= fixar_get_option('general_settings_logo_padding_bottom') != '' ? 'padding-bottom:'.esc_attr(fixar_get_option('general_settings_logo_padding_bottom')).'px;' : '';
	$fixar_logo_stl .= fixar_get_option('general_settings_logo_padding_left') != '' ? 'padding-left:'.esc_attr(fixar_get_option('general_settings_logo_padding_left')).'px;' : '';
				...
				<div class="container ">
					...
					<div class="header-navibox-3 header-level1-box-right">
						...
						<?php endif; ?>
							...
							<li>
								<button class=" js-toggle-<?php echo esc_attr($fixar_header['header_menu_add_position'] == 'screen' ? 'screen' : $fixar_header['header_menu_add_position'].'-slidebar') ?> toggle-menu-button ">
