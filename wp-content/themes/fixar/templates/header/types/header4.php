...
?>
    ...
    <?php if ( !empty( fixar_get_option('header_type4_lmenu', '') ) ) { ?>
        ...
        <nav  class="navbar">
			...
			<div class="header-navibox-2">
				<?php
					wp_nav_menu(array(
	                    'container' => false,
	                    'menu' => fixar_get_option('header_type4_lmenu', ''),
    ...
    <?php if ( !empty( fixar_get_option('header_type4_rmenu', '') ) ) { ?>
       ...
       <nav  class="navbar">
			...
			<div class="header-navibox-2">
				<?php
					wp_nav_menu(array(
	                    'container' => false,
	                    'menu' => fixar_get_option('header_type4_rmenu', ''),
	                    'menu_class' => 'yamm main-menu nav navbar-nav',
					));
				?>
			</div>
    ...
    <?php } ?>
        ...
        <div class="header-decore-bottom">
            ...
            if (fixar_get_option('header_decore', '') == 'style_1') { ?>
           	...
           	<?php } ?> 
            <?php if (fixar_get_option('header_decore', '') == 'style_2') { ?>
