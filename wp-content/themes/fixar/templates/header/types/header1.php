	...
	<?php echo esc_attr($fixar_header['header_uniq_class']) ?>
       ...
       ">
				...
				<div class="container">
					...
					<div class="header-topbarbox-2">
						...
						<ul class="nav navbar-nav hidden-xs">
							...
							<?php } ?>
                            <?php if (fixar_get_option('social_custom_url_4', '')) { ?>
								<li class="header-social-link"><a href="<?php echo esc_url(fixar_get_option('social_custom_url_4', '')); ?>"
								       target="_blank"><i
												class="fa <?php echo esc_attr(fixar_get_option('social_custom_icon_4', '')); ?>"></i></a>
								</li>
							<?php } ?>
                            <?php if (fixar_get_option('social_custom_url_5', '')) { ?>
								<li class="header-social-link"><a href="<?php echo esc_url(fixar_get_option('social_custom_url_5', '')); ?>"
								       target="_blank"><i
												class="fa <?php echo esc_attr(fixar_get_option('social_custom_icon_5', '')); ?>"></i></a>
								</li>
							<?php } ?>
						</ul>
						<?php endif; ?>
					...
					<div class="header-navibox-3">
                        ...
                        <?php
                            if (class_exists('WooCommerce')) {
                                echo fixar_woocommerce_total_cart();
                            }
                        ?>
						...
						<ul class="nav navbar-nav hidden-xs">
							...
							<?php if ( fixar_get_option('header_search') ) : ?>
							<li class="header-search-icon"><a class="btn_header_search" href="#"><i class="fa fa-search"></i></a></li>
						    <?php endif; ?>

							<?php if ( $fixar_header['header_menu_add_position'] != 'disable' ) : ?>
							<li>
                                <?php if ( $fixar_header['header_menu_add_position'] == 'fly' ) : ?>
                                ...
                                <?php else: ?>
                                    <button  id="toggle-theme-menu"  class=" js-toggle-<?php echo esc_attr($fixar_header['header_menu_add_position'] == 'screen' ? 'screen' : $fixar_header['header_menu_add_position'].'-slidebar') ?> toggle-menu-button ">
                                        <span class="toggle-menu-button-icon">
                                            <span></span>
                                            <span></span>
                                            <span></span>
        ...
        <div class="header-decore-bottom">
            ...
            if (fixar_get_option('header_decore', '') == 'style_1') { ?>
           	...
           	<?php } ?> 
            <?php if (fixar_get_option('fixar_header_decore', '') == 'style_2') { ?>
